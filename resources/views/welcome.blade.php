      ...
      <nav id="sidebar"
         ...
         <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
               ...
               <div id="collapseBootstrap1" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
               ...
               <div id="collapseTable5" class="collapse" aria-labelledby="headingTable5" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded"> 
            ...
            <li class="nav-item">
               ...
               <div id="collapseTable6" class="collapse" aria-labelledby="headingTable6" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded"> 
            ...
            <li class="nav-item">
               ...
               <div id="collapseTable7" class="collapse" aria-labelledby="headingTable7" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded"> 
